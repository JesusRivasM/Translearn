...
public class QuizOriginal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_original);
        ...
        check1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(listaTraducciones.get(0).getaTraducir().equals(respuesta1.getText().toString())){
                    respuesta1.setBackgroundColor(Color.GREEN);
                    nota = nota + 1;
                }else{
                    respuesta1.setBackgroundColor(Color.parseColor("#FC8282"));
                    respuesta1.setText(listaTraducciones.get(0).getaTraducir());
        ...
        check2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(listaTraducciones.get(1).getaTraducir().equals(respuesta2.getText().toString())){
                    respuesta2.setBackgroundColor(Color.GREEN);
                    nota = nota + 1;
                }else{
                    respuesta2.setBackgroundColor(Color.parseColor("#FC8282"));
                    respuesta2.setText(listaTraducciones.get(1).getaTraducir());
        ...
        check3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(listaTraducciones.get(2).getaTraducir().equals(respuesta3.getText().toString())){
                    respuesta3.setBackgroundColor(Color.GREEN);
                    nota = nota + 1;
                }else{
                    respuesta3.setBackgroundColor(Color.parseColor("#FC8282"));
                    respuesta3.setText(listaTraducciones.get(2).getaTraducir());
        ...
        check4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(listaTraducciones.get(3).getaTraducir().equals(respuesta4.getText().toString())){
                    respuesta4.setBackgroundColor(Color.GREEN);
                    nota = nota + 1;
                }else{
                    respuesta4.setBackgroundColor(Color.parseColor("#FC8282"));
                    respuesta4.setText(listaTraducciones.get(3).getaTraducir());
        ...
        check5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(listaTraducciones.get(4).getaTraducir().equals(respuesta5.getText().toString())){
                    respuesta5.setBackgroundColor(Color.GREEN);
                    nota = nota + 1;
                }else{
                    respuesta5.setBackgroundColor(Color.parseColor("#FC8282"));
                    respuesta5.setText(listaTraducciones.get(4).getaTraducir());
    ...
    public void rellenarPreguntas(ArrayList<Traduccion> listaTraducciones){
        pregunta1.setText(listaTraducciones.get(0).getTraducido());
        pregunta2.setText(listaTraducciones.get(1).getTraducido());
        pregunta3.setText(listaTraducciones.get(2).getTraducido());
        pregunta4.setText(listaTraducciones.get(3).getTraducido());
        pregunta5.setText(listaTraducciones.get(4).getTraducido());
    }
}